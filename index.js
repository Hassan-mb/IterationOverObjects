...
********************************/
person.enail = "Hassan.m.behbahani@gmail.com";
/******************************
...
//Q4
const movieNames = movies.forEach((movie) => {
...
const movieReleases = (moviesArray) => {
  return moviesArray.filter((movie) => movie.year === 1994).length;
};
console.log(movieReleases(movies));
/******************************
